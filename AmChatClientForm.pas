...
type
  ...
  private
    { Private declarations }
     ...
     FFormPopapNewMessageOnOpenDialog:TNotifyEvent;
   ...
   const
    ...
    var
        ...
        procedure FormPopapNewMessageOnOpenDialog (Id,TypeUser:string);
  public
  ...
  //   BoxOnlineScroll:TAmClientScroll;
     ...
     procedure ChatClientStart ( aAddressSocket:string;  aPortSokect:integer;  MiliSecondsTimeOutSocket:Cardinal=INFINITE);
     ...
     property  OnFormPopapNewMessageOnOpenDialog : TNotifyEvent read FFormPopapNewMessageOnOpenDialog write FFormPopapNewMessageOnOpenDialog;
  end;
...
begin
    ...
    FormPopapNewMessageCreate;
    FormPopapNewMessage.OnOpenDialog:= ChatClientForm.FormPopapNewMessageOnOpenDialog;
    ChatClientForm.ChatClient.OnLog:= aLog.LogProc;
    //77.220.213.53 127.0.0.1
    ChatClientForm.ChatClientStart(aAddressSocket,aPortSokect,10000);
end;
procedure ChatClientFormDestroy();
begin
...
procedure TChatClientForm.FormPopapNewMessageOnOpenDialog (Id,TypeUser:string);
begin
 if Assigned( FFormPopapNewMessageOnOpenDialog ) then FFormPopapNewMessageOnOpenDialog(Self);
 ChatClient.GetHistoryChat(Id,TypeUser);
end;
...
procedure TChatClientForm.ChatClientStart ( aAddressSocket:string;  aPortSokect:integer; MiliSecondsTimeOutSocket:Cardinal=INFINITE);
begin
    ChatClient.Start(aAddressSocket,aPortSokect,MiliSecondsTimeOutSocket);
end;

...
uses
  ...
  type
   ...
   type
    ...
    private
     ...
     protected
       ...
       procedure   Log(msg:string;exception:Exception=nil);override;
    public
      NameThr:string;
   ...
   type
    TAmClientSockFile = class(TAmObject)
...
implementation
                    ...
                    {SockFile}
constructor TAmClientSockFile.Create();
begin
    inherited Create;
  ...
  //  Download.Start;
    ...
    DownloadPhotoContact.OnLog:=self.LogEvent;
  ...
  try
     ...
     try
       try
         ...
         Log('Error.TAmClientFileThreadDownload.Download 2 ',e);
         end;
          ...
          begin
            ...
            try
               ...
               begin
                 ...
                 JsonArray:= amJson.LoadArrayText(ResultAdd.ListFileOtherJson);
                 try
                 ...
                 JsonArray:= amJson.LoadArrayText(ResultAdd.ListFilePhotoJson);
                 try
...
procedure   TAmClientFileThread.Log(msg:string;exception:Exception=nil);
begin
   inherited Log(NameThr+' '+msg,nil);
end;
...
begin
   ...
   begin
    ...
    Json:= amJson.LoadObjectText(Param.JsonSring);
    try
...
begin
    ...
    Json:= amJson.LoadObjectText(ResultJsonString);
    try
